...
export default function ProjectAnalytics() {
    ...
    const fetchSalesData = async (projectid) => {
        ...
        try {
            ...
            const response = await httpService.get(`/project-analytics/getProjectSales/${projectid}`);
    ...
    const fetchReceivedAmountData = async (projectid) => {
        ...
        try {
            ...
            const response = await httpService.get(`/project-analytics/getProjectReceivedAmount/${projectid}`);
            let data = prepareSalesChartData(response.data, "#13ba82", "Received amount");
    ...
    const fetchClientCountData = async (projectid) => {
        ...
        try {
            ...
            const response = await httpService.get(`/project-analytics/getProjectClientCount/${projectid}`);
            let data = prepareSalesChartData(response.data, "#0ea5e9", "Clients Count");
    ...
    const fetchExpenseData = async (projectid) => {
        ...
        try {
            ...
            const response = await httpService.get(`/project-analytics/getProjectExpense/${projectid}`);
            let purchased = prepareSalesChartData(response.data.purchase, "#4c51bf", "Purchased Amount");
            let paid = prepareSalesChartData(response.data.paid, "#13ba82", "Paid Amount");
            let credit = prepareSalesChartData(response.data.credit, "#ef4444", "Credit Amount");
            ...
            <div className="container mx-auto p-4">
                <div className="w-full mb-6 ">
                    <div className="flex flex-wrap">
                        ...
                        <div className="lg:w-4/12 shadow-lg  bg-white p-2 rounded text-sm">
                            <p className="">
                            ...
                            <p className="">
                                <span className="font-semibold pr-2">Construction Amount:</span>{" "}
                            ...
                            <p className="">
                                <span className="font-semibold pr-2">Duration In Months:</span>{" "}
            ...
            <div className="container mx-auto p-4">
                <div className="flex flex-wrap">
                    ...
                    <div className="lg:w-4/12">
                        <BarChartDynamic chartData={salesChart} title="Sales" subtitle="Monthly Summary" />
                    </div>
                    <div className="lg:w-4/12">
                        <BarChartDynamic chartData={recievedamountChart} title="Recieved Amount" subtitle="Monthly Summary" />
                    </div>
                    <div className="lg:w-4/12">
                        <BarChartDynamic chartData={clientCountChart} title="Client Count" subtitle="Monthly Summary" />
                    </div>
                    <div className="w-full">
                        <BarChartDynamic chartData={expenseChart} title="Expense" subtitle="Monthly Summary" />
                    </div>
                    {/* <div className="lg:w-4/12">
