            ...
            <ul className="flex flex-row flex-wrap list-none lg:ml-auto navbar-social-icons">
              ...
              <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <i className="lg:text-blueGray-200 logo-blue-color fab fa-facebook text-lg leading-lg " />
              ...
              <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <i className="lg:text-blueGray-200 logo-blue-color fab fa-twitter text-lg leading-lg " />
              ...
              <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <i className="lg:text-blueGray-200 logo-blue-color fab fa-github text-lg leading-lg " />
